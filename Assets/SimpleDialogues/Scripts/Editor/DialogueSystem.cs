...
public class DialogueSystem : EditorWindow
{
    ...
    void WindowFunction(int windowID)
    {
        ...
        Win.Trigger = GUI.Toggle(new Rect(5, 100, 60, 30), Win.Trigger, "Trigger");
        if (Win.Trigger)
        {
        ...
        GUI.Label(new Rect(0, 15, 40, 20), "Owner");
        Win.Owner = GUI.TextField(new Rect(50, 15, xSize - 60, 20), Win.Owner);
        Win.Text = GUI.TextArea(new Rect(0, 35, xSize, ySize), Win.Text);
